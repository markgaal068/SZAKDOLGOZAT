  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gradient-to-b from-bg via-sndbg to-accent text-white text-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-2xl z-10 px-4 sm:px-8 md:px-12">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">Üdvözlünk a Kinizsi Lövészeti Szakosztályánál!</h1>
        <p className="text-base sm:text-lg md:text-xl mb-8">
          A Kinizsi Lövészeti szakosztálya több évtizedes múltra tekint vissza. 
        ...
        <div className="mt-8">
          <p className="text-sm italic">Köszönjük, hogy érdeklődsz a Kinizsi Lövészeti szakosztálya iránt!</p>
        </div>
      </div>
    </div>
  );
