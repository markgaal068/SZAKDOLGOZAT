...
async function scrapeTable() {
  ...
  // Load the page
  await page.goto('https://www.mksz.hu/versenyek/felnottFerfiVersenyek/32024585/320223238', {waitUntil: 'networkidle2'});
  ...
  fs.writeFileSync('mkszffifelnott.json', JSON.stringify(tableData, null, 2));
