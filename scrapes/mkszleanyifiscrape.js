...
async function scrapeTable() {
  ...
  // Load the page
  await page.goto('https://www.mksz.hu/versenyek/upNoiVersenyek/32024313/320222899', {waitUntil: 'networkidle2'});
  ...
  fs.writeFileSync('mkszleanyifi.json', JSON.stringify(tableData, null, 2));
