...
async function scrapeTable() {
  ...
  // Load the page
  await page.goto('https://www.mksz.hu/versenyek/felnottNoiVersenyek/32024569/320223154', {waitUntil: 'networkidle2'});
  ...
  fs.writeFileSync('mksznoifelnott.json', JSON.stringify(tableData, null, 2));
